 ...
 */
import root from '../../website/src/index.server';
 ...
 */
const privateKey = fs.readFileSync(path.join(__dirname, '../../certificates/domain.key'));
const certificate = fs.readFileSync(path.join(__dirname, '../../certificates/domain.crt'));
